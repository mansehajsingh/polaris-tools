...
public class SourcePolarisOptions extends BasePolarisOptions {
  ...
  @CommandLine.Option(
      names = "--source-" + AUTHENTICATION_PROPERTIES,
      required = true,
      description = "The authentication configuration for the service admin on the source Polaris.")
  @Override
