...
/**
 * Service to provide auth headers for requests made to Polaris. Encapsulates Iceberg auth client code
 * that enables token refresh to be provided out of the box.
 */
